...
class AuthorModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        Author.objects.create(name='Big', date_of_birth='2008-10-10', date_of_dead='2008-9-9', slug='big')

    def test_first_name_label(self):
        author = Author.objects.get(id=1)
        field_label = author._meta.get_field('name').verbose_name
        self.assertEquals(field_label, 'Имя автора')
    ...
    def test_get_absolute_url(self):
        ...
        self.assertEquals(author.get_absolute_url(), '/catalog/author/big/')
